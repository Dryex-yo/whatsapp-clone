...
return [
    ...
    */
    ...
    | to broadcast events to other parts of your application. As you build
    | your application, be sure to add additional connections as needed.
    |
    */
    ...
    'connections' => [
         ...
         * 
         * For real-time WebSocket broadcasting with Laravel Reverb
         * Update BROADCAST_DRIVER=reverb in .env when Reverb is installed
         */
        'reverb' => [
            'driver' => 'reverb',
